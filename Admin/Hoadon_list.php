...
<body>
	<div id="tong">
		...
		<?php
			...
			$sql = "SELECT hoa_don.ma_hd, khach_hang.ten_kh, hoa_don.dia_chi, hoa_don.ngay_mua, hoa_don.trang_thai FROM hoa_don JOIN khach_hang ON hoa_don.ma_kh = khach_hang.ma_kh";

			if (isset($_GET["search"])) {
		        $search = $_GET["search"];
		    	$sql_search = "SELECT hoa_don.ma_hd, khach_hang.ten_kh, hoa_don.dia_chi, hoa_don.ngay_mua, hoa_don.trang_thai FROM hoa_don JOIN khach_hang ON hoa_don.ma_kh = khach_hang.ma_kh WHERE ma_hd ='$search'";
		...
		<div id="danh_sach_sp">
	    	...
	    	<div id="search">
	    		<form action="Hoadon_list.php">
					<input type="text" name="search" placeholder="Nhập mã hóa đơn...">
					<button>Tìm</button>
				</form>
	    	</div>
