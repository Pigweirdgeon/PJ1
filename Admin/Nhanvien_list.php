	    	...
	    	<div id="bang">
	    		...
	    		<table border="1px" cellspacing="0" cellpadding="10px">
	    			...
	    			<tr>
	    				...
	    				<td><a href="Nhanvien_fix.php?id=<?php echo $nv["ma_nv"]; ?>">Sửa</a><br>
	                                    <a href="../process/xoa_nhan_vien.php?id=<?php echo $nv["ma_nv"] ?>" onclick="return confirm('Bạn có chắc chắn muốn gỡ người này? Thao tác này không thể hoàn tác.')">Gỡ</a></td>
	    			</tr>
